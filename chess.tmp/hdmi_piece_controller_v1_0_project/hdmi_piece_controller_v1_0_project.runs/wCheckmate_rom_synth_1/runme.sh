...
HD_PWD='c:/users/ahmed/documents/ece385/chess/chess.tmp/hdmi_piece_controller_v1_0_project/hdmi_piece_controller_v1_0_project.runs/wCheckmate_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wCheckmate_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wCheckmate_rom.tcl
