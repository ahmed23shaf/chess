...
#
# Generated by export_simulation on Tue Apr 30 08:10:58 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './wToPlay_rom.sh' script.

./wToPlay_rom.sh -reset_run
...
./wToPlay_rom.sh -noclean_files

For more information on the script, please type './wToPlay_rom.sh -help'.
