...
#
# Generated by export_simulation on Tue Apr 30 08:20:08 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './draw_rom.sh' script.

./draw_rom.sh -reset_run
...
./draw_rom.sh -noclean_files

For more information on the script, please type './draw_rom.sh -help'.
