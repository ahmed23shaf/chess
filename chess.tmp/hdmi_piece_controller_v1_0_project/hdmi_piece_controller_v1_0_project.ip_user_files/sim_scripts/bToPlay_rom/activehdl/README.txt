...
#
# Generated by export_simulation on Tue Apr 30 08:13:59 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './bToPlay_rom.sh' script.

./bToPlay_rom.sh -reset_run
...
./bToPlay_rom.sh -noclean_files

For more information on the script, please type './bToPlay_rom.sh -help'.
