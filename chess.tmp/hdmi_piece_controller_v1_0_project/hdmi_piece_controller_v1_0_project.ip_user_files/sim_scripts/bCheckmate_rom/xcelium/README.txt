...
#
# Generated by export_simulation on Tue Apr 30 08:19:34 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './bCheckmate_rom.sh' script.

./bCheckmate_rom.sh -reset_run
...
./bCheckmate_rom.sh -noclean_files

For more information on the script, please type './bCheckmate_rom.sh -help'.
