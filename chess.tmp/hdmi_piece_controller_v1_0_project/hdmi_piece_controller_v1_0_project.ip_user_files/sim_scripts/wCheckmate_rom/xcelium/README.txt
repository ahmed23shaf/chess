...
#
# Generated by export_simulation on Tue Apr 30 08:16:48 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './wCheckmate_rom.sh' script.

./wCheckmate_rom.sh -reset_run
...
./wCheckmate_rom.sh -noclean_files

For more information on the script, please type './wCheckmate_rom.sh -help'.
