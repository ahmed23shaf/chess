...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../chess.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../chess.gen/sources_1/bd/mb_usb/ipshared/7698" \
       +incdir+"../../../../chess.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"../../../../chess.gen/sources_1/bd/mb_usb/ipshared/7698" \
       +incdir+"../../../../chess.gen/sources_1/bd/mb_usb/ip/mb_usb_hdmi_piece_controller_0_0_1/src/clk_wiz_0" \
       -input simulate.do
}
